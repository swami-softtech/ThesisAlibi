...
const WorkFlow = () => {
  ...
  return (
    <>
      <SEO
        title="Workflow"
        description="Discover how ThesisAlibi works—from consultation to completion. Learn about our structured process for delivering high-quality thesis support and academic guidance."
        keywords="thesis workflow, academic writing process, thesis assistance steps, research support process, how ThesisAlibi works, thesis project workflow"
      />

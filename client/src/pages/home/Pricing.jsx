...
export function Pricing() {
    ...
    return (
        <>
            <SEO
                title="Pricing"
                description="View transparent and flexible pricing plans for thesis assistance, research support, and academic writing services. Choose the right plan for your academic needs with ThesisAlibi."
                keywords="thesis pricing, academic writing cost, thesis help plans, research assistance pricing, student support packages, ThesisAlibi pricing"
            />
            <Layout>
                {loading && (
